...
ai_gateway_litellm_install(version='0.3.0', instance=False)
...
k8s_resource('claims-database', labels=['showcase'], resource_deps=['agent-runtime', 'mongodb'], port_forwards=['12021:8000'])
