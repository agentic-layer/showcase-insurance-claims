...
const ws_url =
  ws_protocol + "//" + window.location.host + "/ws/" + sessionId;
let websocket = null;
let is_audio = false;
...
function connectWebsocket() {
  ...
  websocket.onmessage = function (event) {
    ...
    if (message_from_server.mime_type == "text/plain") {
      ...
      if (message_from_server.is_user_input) {
        // Display user input with a different style
        const userMessage = document.createElement("pre");
        userMessage.textContent = message_from_server.data;
        userMessage.style.fontStyle = "italic";
        userMessage.style.color = "#666";
        userMessage.style.whiteSpace = "pre-wrap";
        userMessage.style.fontFamily = "inherit";
