          ...
          <Table>
            <TableHeader>
              <TableRow>
                ...
                <TableHead>Versicherungen</TableHead>
              </TableRow>
            </TableHeader>
            <TableBody>
              {customers.map(([customerId, customer]) => (
                <React.Fragment key={customerId}>
                  ...
                  >
                    ...
                    <TableCell>{customer.address.street}, {customer.address.postal_code} {customer.address.city}</TableCell>
                    <TableCell>{customer.policies.length} Police(s)</TableCell>
                  </TableRow>
                  {expandedRows.has(customerId) && (
                    <TableRow>
                              ...
                              <div className="space-y-2">
                                <div className="p-3 bg-background rounded border">
                                  <div className="space-y-1">
                                    <p><span className="font-medium">Kunden-ID:</span> {customer.customer_id}</p>
                                    <p><span className="font-medium">Telefon:</span> {customer.phone}</p>
                                    <p><span className="font-medium">E-Mail:</span> {customer.email}</p>
                                    <p><span className="font-medium">Adresse:</span> {customer.address.street}, {customer.address.postal_code} {customer.address.city}, {customer.address.country}</p>
                                  </div>
                                </div>
                              </div>
                            </div>
                            <div>
                              <h4 className="font-semibold mb-3">Versicherungspolicen</h4>
                              <div className="space-y-2">
                                  ...
                                  <div key={policy.policy_id} className="p-3 bg-background rounded border">
                                    <div className="space-y-1">
                                      ...
                                      <p className="text-sm text-muted-foreground">
                                        Police-Nr.: {policy.policy_id}
                                      </p>
                                      <p className="text-sm text-muted-foreground">
                                        Start: {formatDate(policy.start_date)}
                                      </p>
                                      {policy.vehicles && policy.vehicles.map((vehicle, index) => (
                                        <div key={index} className="mt-2 p-2 bg-muted rounded">
                                          ...
                                          <p className="text-sm text-muted-foreground">Kennzeichen: {vehicle.license_plate}</p>
                                        </div>
                                      ))}
                                    </div>
                                  </div>
